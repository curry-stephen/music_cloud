  ...
  methods: {
    getUserInfo (id) {
      HttpManager.getUserOfId(id)
        .then(res => {
          this.registerForm.username = res[29].username
          this.registerForm.password = res[29].password
          this.registerForm.sex = res[29].sex
          this.registerForm.phoneNum = res[29].phoneNum
          this.registerForm.email = res[29].email
          this.registerForm.birth = res[29].birth
          this.registerForm.introduction = res[29].introduction
          this.registerForm.location = res[29].location
          this.registerForm.userPic = res[29].avator
        })
        .catch(err => {
          console.error(err)
        })
