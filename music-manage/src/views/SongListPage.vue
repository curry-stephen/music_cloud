  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-button type="primary" size="small" @click="centerDialogVisible = true">添加歌单</el-button>
      </div>
      <el-table :data="data" border size="small" style="width: 100%" height="550px" ref="multipleTable" @selection-change="handleSelectionChange">
    ...
    <el-dialog title="添加歌单" v-model="centerDialogVisible" width="400px" center>
      <el-form :model="registerForm" status-icon ref="registerForm" label-width="70px" class="demo-ruleForm">
          <el-form-item label="歌单名" prop="title" size="small">
            <el-input v-model="registerForm.title" placeholder="歌单名"></el-input>
          </el-form-item>
          <el-form-item label="歌单介绍" prop="introduction" size="small">
            <el-input v-model="registerForm.introduction" placeholder="歌单介绍"></el-input>
          </el-form-item>
          <el-form-item label="风格" prop="style" size="small">
    ...
    <!-- 删除提示框 -->
    <young-del-dialog :delVisible="delVisible" @deleteRow="deleteRow" @cancelRow="delVisible = $event"></young-del-dialog>
  </div>
</template>
...
import { LIST_SONG, COMMENT } from '../enums'
import YoungDelDialog from '@/components/dialog/YoungDelDialog'
